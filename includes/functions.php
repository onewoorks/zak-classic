...
function updateselectcaw() {
    ...
    global $db;
    $a = $db->execute("SELECT caw_id, caw_head FROM tbl_cawangan WHERE caw_stat = 0");
    while ($b = mysqli_fetch_array($a)) {
...
class transaksi {
    ...
    public function allrekod($x) {
        ...
        while ($b = mysqli_fetch_array($a)) {
            ...
            echo "<div class='col no2'>" . textlen(getahliname($b['stf_id']), 17) . "&nbsp;</div>";
            ...
            if ($b['at_kategori'] == 1) {
                ...
                //echo "<div class='col no4 tright'>".kategori($b['at_kategori'])."&nbsp;</div>";
                echo "<div class='col no4 tright'>&nbsp;</div>";
                echo "<div class='col no4 tright'>" . number_format($b['at_jumlah'], 2, '.', ',') . "&nbsp;</div>";
                $jk = $jk + $b['at_jumlah'];
            }
    ...
    public function bakilepas($x) {
        ...
        //echo "<div class='col no4'>&nbsp;</div>";
        echo "<div class='col no2'>&nbsp;</div>";
        echo "<div class='col no7 tright bleft'>" . number_format($result, 2, '.', ',') . "&nbsp;</div>";
        echo "<div class='col no7 tright'>&nbsp;</div>";
        echo "<div class='col no7 tright bleft'>" . number_format($emasberat, 1, '.', ',') . "&nbsp;</div>";
        echo "<div class='col no7 tright'>" . number_format($emasguna, 2, '.', ',') . "&nbsp;</div>";
    ...
    public function bulanan() {
        ...
        //echo "<div class='col no4'>Staf</div>";
        echo "<div class='col no2'>Cawangan</div>";
        ...
        global $db;
        $a = $db->execute("SELECT * FROM tbl_alirantunai WHERE at_timeDate LIKE '$thismonth' ORDER BY at_timeDate ASC ");
        $c = mysqli_num_rows($a);
        while ($b = mysqli_fetch_array($a)) {
            echo "<div class='data small'>";
            echo "<div class='col no1'>" . $i++ . "</div>";
            ...
            //echo "<div class='col no4'>".getahliname($b['stf_id'])."&nbsp;</div>";
            echo "<div class='col no2'>" . textlen(getnamacawangan($b['caw_id']), 17) . "&nbsp;</div>";
            if ($b['at_kategori'] == 1) {
        ...
        //echo "<div class='col no4'>&nbsp;</div>";
        echo "<div class='col no2'>&nbsp;</div>";
        echo "<div class='col no7 tright bbleft'>" . number_format($masuk, 2, '.', ',') . "</div>";
        echo "<div class='col no7 tright'>" . number_format($keluar, 2, '.', ',') . "</div>";
        echo "<div class='col no7 tright bbleft'>" . number_format($beratemas, 1, '.', ',') . "</div>";
        echo "<div class='col no7 tright'>" . number_format($emasguna, 2, '.', ',') . "</div>";
        echo "<div class='clear'></div>";
        echo "</div></b>";
        ...
        echo "<div class='col lda tright'>" . number_format($masuk, 2, '.', ',') . "</div><div class='clear'></div>";
        echo "<div class='col lab'>KELUAR</div>";
        echo "<div class='col lda tright'>" . number_format($keluar, 2, '.', ',') . "</div><div class='clear'></div>";
        echo "<div class='col lab'>BAKI BULAN INI</div>";
        echo "<div class='col lda tright'>" . number_format(($masuk - $keluar), 2, '.', ',') . "</div><div class='clear'></div>";
        echo "<br /><br />";
    }
...
//    }
    ...
    public function resultsemakan($x) {
        echo "<b><div>";
        echo "<div class='col no1'>No</div>";
        echo "<div class='col no8'>Tarikh dan Masa</div>";
        echo "<div class='col no2'>Perkara</div>";
        ...
        echo "<div class='col no7 cen'>Keluar</div>";
        echo "<div class='col no7 cen'>Berat (g)</div>";
        echo "<div class='col no7 cen'>Nilai Emas</div>";
        ...
        $totalNilaiEmas = 0;
        global $db;
        $a = $db->execute("SELECT * FROM tbl_alirantunai WHERE caw_id='$x' ORDER BY at_timeDate DESC");
        $c = mysqli_num_rows($a);
        while ($b = mysqli_fetch_array($a)) {
            echo "<div class='data small'>";
            echo "<div class='col no1'>" . $i++ . "</div>";
            ...
            if ($b['at_kategori'] == 1) {
                $n = curr($b['at_jumlah']);
                $m = "";
                $baki = curr((($b['at_guna'] + $b['at_jumlah'])));
                $nilai = $nilai + ($b['at_guna'] + $b['at_jumlah']);
                $nilaimasuk = $nilaimasuk + $b['at_jumlah'] + $b['at_guna'];
                $totBaki = $totBaki + (($b['at_guna'] + $b['at_jumlah']));
            } else {
                $n = "";
                $m = curr($b['at_jumlah']);
                $baki = "(" . curr(($b['at_jumlah'] + $b['at_guna'])) . ")";
                $nilai = $nilai + ($b['at_guna'] + $b['at_jumlah']);
                $nilaikeluar = $nilaikeluar + $b['at_jumlah'] + $b['at_guna'];
                $totBaki = $totBaki - ($b['at_jumlah'] + $b['at_guna']);
            }
            ...
            if ($b['at_beratEmas'] > 0) {
                echo $b['at_beratEmas'];
                $totalEmas += $b['at_beratEmas'];
            }
            echo "&nbsp;</div>";
            echo "<div class='col no7 tright'>";
            if ($b['at_guna'] > 0) {
                echo curr($b['at_guna']);
                $totalNilaiEmas += $b['at_guna'];
            }
            echo "&nbsp;</div>";
        ...
        echo "<div class='col no2'>&nbsp;</div>";
        echo "<div class='col no2'>&nbsp;</div>";
        echo "<div class='col no7 tright bbleft'>" . curr($nilaimasuk) . "&nbsp;</div>";
        echo "<div class='col no7 tright'>" . curr($nilaikeluar) . "&nbsp;</div>";
        echo "<div class='col no7 tright bbleft'>" . curr($totalEmas) . "&nbsp;</div>";
        echo "<div class='col no7 tright'>" . curr($totalNilaiEmas) . "&nbsp;</div>";
        echo "<div class='col no4 tright bbleft'>" . curr($totBaki) . "</div>";
        echo "<div class='clear'></div>";
        echo "</div></b>";
        ...
        echo "<div class='col no3'>Jumlah Emas</div>";
        echo "<div class='col no4 tright'>" . curr($totalEmas) . "</div>";
        echo "<div class='clear'></div>";
        echo "<div class='col no3'>Jumlah Nilai Emas</div>";
        echo "<div class='col no4 tright'>" . curr($totalNilaiEmas) . "</div>";
        echo "<div class='clear'></div>";
        echo "<br />";
    }
...
class rumusan extends widget {
    ...
    public function display() {
        ...
        echo "<div class='col no6 line rem bbleft bbright bbtop mspa tright'>" . curr($this->akaunsemua(1)) . "&nbsp;</div>";
        echo "<div class='clear'></div>";
        ...
        echo "<div class='col no2 dbl bbleft mspa bco'><b>Dalam Akaun</b></div>";
        echo "<div class='col no6 dbl rem bbleft mspa tright'><b>" . curr(($this->akaunbulanini(1) - $this->akaunbulanini(2))) . "&nbsp;</b></div>";
        echo "<div class='col no6 dbl rem bbleft bbright mspa tright'><b>" . curr(($this->akaunsemua(1) - $this->akaunsemua(2))) . "&nbsp;</b></div>";
        echo "<div class='clear'></div>";
